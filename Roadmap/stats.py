#Este script de Python está diseñado para recorrer una estructura de directorios y archivos, recopilando estadísticas sobre los "desafíos" 
#(challenges), los (languages) y los usuarios (users) que han contribuido a los archivos en estos directorios --> JSON
import os
import re
import json
